...
namespace ProductShop
{
    public class StartUp
    {
        public static void Main()
        {
            ...
            //string productsCategories = File.ReadAllText("../../../Datasets/categories-products.json");
            //Console.WriteLine(ImportCategoryProducts(context, productsCategories));
